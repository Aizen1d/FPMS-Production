...
<body>
    <nav id="sidebarMenu" class="collapse d-lg-block sidebar">
        <div class="position-sticky">
            ...
            <div id="sub-task">
                <a href="{{ route('faculty-tasks/researches/view') }}" class="list-group-item list-group-item-action py-2 sub ripple bg
                {{ (request()->is('faculty-tasks/researches/view')) ? 'active' : '' }}">
                    <span>View</span>
                </a>
                </a>
            </div>
