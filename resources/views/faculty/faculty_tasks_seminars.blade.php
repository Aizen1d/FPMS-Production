...
<div class="container-fluid margin">
    ...
    <div class="create-task-popup">
        ...
        <div id="loading-overlay" class="loading-create-task" style="display: flex; justify-content: center; height: 190vh; align-items: center; border-radius: 25px; z-index: 99; position: absolute; top: 0; left: 0; right: 0; bottom: 0; background-color: white;">
