...
<div class="container-fluid margin">
      ...
      <div class="row mt-3">
        <div class="col-12">
          <div class="ms-3 mt-4">
            ...
            <div class="d-flex flex-column mt-4">
                <label class="research-labels ms-3" for="">Published at*</label>
                <input class="research-input" id="published-at-input" type="text" placeholder="Enter name of journal" value="{{ $research->published_at }}">
            </div>

            <div class="d-flex flex-column mt-4">
              <label for="" class="research-labels ms-3">Date of Publication*</label>
              <input class="ms-3" type="date" id="date-picker" min="1997-01-01" max="2030-01-01" value="{{ $date_published }}">
            </div>
            ...
            <div id="loading-overlay" class="loading-save-task" style="display: none; justify-content: center; align-items: center; height: 150vh; border-radius: 25px; z-index: 99; position: absolute; top: 0; left: 0; right: 0; bottom: 0; background-color: white;">
    ...
    <script>
      ...
      function disableForm() {
        ...
        let publishedAt = document.getElementById('published-at-input');
      ...
      fetch(`/admin-tasks/researches/getAttachments?category=${category}&id=${researchId}`)
        ...
        function validateForm() {
            ...
            let publishedAt = document.getElementById('published-at-input').value;
            ...
            if (publishedAt.trim() === '') {
                showNotification('Please enter the published at.', '#fe3232bc');
                return false;
            }
