...
<div class="container-fluid margin">
    <div class="row">
        <div class="col-7">
            <h1 class="my-4 title">{{ $department }} Program <span style="font-size: 0.4em; color: #9c9a9a; font-weight: normal;">Note: One missing memo by a member, that memo will be listed here.</span></h1>
        </div>
    ...
    <script>
        ...
        const debouncedInputHandler = debounce(function(event) {
            ...
            fetch(`/admin-tasks/department/category/search?query=${query}&category=missing`)
                .then(response => response.json())
                .then(newTasks => {
                    tasks = newTasks;
                    newlyAdded = null;
