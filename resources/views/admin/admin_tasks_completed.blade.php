...
<div class="container-fluid margin">
    <div class="row">
        <div class="col-5">
            <h1 class="my-4 title">Tasks <span style="font-size: 0.4em; color: #9c9a9a; font-weight: normal;">Note: Only completed tasks by all assigned members are listed here.</span></h1>
        </div>
    ...
    <script>
        ...
        const debouncedInputHandler = debounce(function(event) {
            ...
            fetch(`/admin-tasks/category/search?query=${query}&category=completed`)
                .then(response => response.json())
                .then(newTasks => {
                    tasks = newTasks;
                    newlyAdded = null;
