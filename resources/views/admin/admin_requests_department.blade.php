...
<div class="container-fluid margin">
    ...
    <div class="container-fluid item-list" style="position: relative;">
        <div class="row">
            ...
            <div class="col-3">
                <h5 class="my-3 column-name" style="z-index: 100; position: relative; text-align:left; margin-left: 30%">Fullname</h5>
            </div>
            <div class="col-2">
                <h5 class="my-3 column-name" style="z-index: 100; position: relative; text-align:left; margin-left: 12%">Program Request</h5>
            </div>
            <div class="col-2">
        ...
        @foreach ($items as $item)
            <div class="row item-row">
                <div class="col-2 column-1">
                    <h5 class="item-row-content my-2 column-0-text" style="text-align:left; margin-left: 32%">
                        {{ $item->getFacultyForeign->username }}
                    </h5>
                </div>
                <div class="col-3 column-1">
                    <h5 class="item-row-content my-2 column-1-text" style="text-align:left; margin-left: 30%">
                ...
                <div class="col-2 column-2">
                    <h5 class="item-row-content px-3 my-2 column-2-text" style="text-align:left; margin-left: 5%">{{ $item->department_name}}</h5>
                </div>
                <div class="col-2 column-3">
                    <h5 class="item-row-content my-2 column-3-text" style="text-align:left; margin-left: 27%">{{ date('F j, Y', strtotime($item->created_at)) }}<br>{{ date('g:i A', strtotime($item->created_at)) }}</h5>
                </div>
