...
@section('title', 'PUPQC - Seminars')

@section('styles')
<link rel="stylesheet" type="text/css" href="{{ asset('admin/css/admin_tasks_seminars.css') }}">
@endsection
...
<div class="container-fluid margin">
    <div class="row">
        ...
        <div class="col-6 drop-down-container">
            <input type="text" class="search-input mx-5" id="search-input" placeholder="Search name of act...">
        ...
        <div class="row mt-3">
            <div class="col-12">
                <div class="ms-3">
                    ...
                    <div class="d-flex flex-column mt-1 ms-2" style="margin-left: 2% !important">
    ...
    <div class="container-fluid task-list" style="position: relative;">
        <div class="row">
            <div class="col-6">
                <h5 class="my-3 column-name" style="z-index: 100; position: relative;">Name of Activity</h5>
            </div>
            <div class="col-6">
        ...
        <div class="task-container">
            ...
            <div class="row task-row" onclick="getSelectedItemRow({{ $item }})">
                <div class="col-6">
                    <h5 class="task-row-content my-2 task-name-text" style="text-align:left; margin-left: 41%">{{ $item->name_of_activity }}</h5>
                </div>
                <div class="col-6">
    ...
    <script>
        ...
        const debouncedInputHandler = debounce(function(event) {
            ...
            fetch(`/admin-tasks/seminars/search?query=${query}`)
        ...
        function submitForm() {
            ...
            fetch('/admin-tasks/seminars/create', {
                    headers: {
                ...
                .then(data => {
                    console.log(data);
                    if (data.newlyAddedSeminar) {
                        showNotification('Seminar created successfully', '#32fe32bc');
                        closeNewTask();
                        resetForm();

                        let tasks = data.allSeminars;
                        let newlyAdded = data.newlyAddedSeminar;
        ...
        function getSelectedItemRow(item) {
            window.location.href = `/admin-tasks/seminars/view?id=${item.id}`;
        }
