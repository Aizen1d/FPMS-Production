...
<div class="container-fluid margin">
    <div class="row">
        <div class="col-7">
            <h1 class="my-4 title">{{ $department }} Program <span style="font-size: 0.4em; color: #9c9a9a; font-weight: normal;">Note: Only late-completed memo by all assigned members are listed here.</span></h1>
        </div>
