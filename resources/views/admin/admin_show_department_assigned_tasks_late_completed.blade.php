...
<div class="container-fluid margin">
    <div class="row">
        <div class="col-7">
            <h1 class="my-4 title">{{ $department }} Program <span style="font-size: 0.4em; color: #9c9a9a; font-weight: normal;">Note: Only late-completed tasks by all assigned members are listed here.</span></h1>
        </div>
            ...
            <div class="row">
                <div class="col-3">
                    <div class="drop-down create-dropdown2">
                        <div class="wrapper">
                            <img src="{{ asset('admin/images/PUPLogo.png') }}" alt=" " class="selectedImg selectedImg3">
                            <div class="selected selected3">Select Department</div>
                        </div>
    ...
    <script>
        ...
        function resetTaskInputs() {
            ...
            departmentDropdown.textContent = 'Select Department';
        ...
        list.addEventListener('click', (e) => {
            ...
            if (item) {
                ...
                fetch('/admin-tasks/category/filter-department', {
                        headers: {
        ...
        dropdown2.addEventListener('click', () => {
            if (document.querySelector('.selected3').textContent !== 'Select Department') {
                ...
                showNotification("Select a department first.", '#fe3232bc');
            }
        });
        ...
        function createTask() {
            ...
            if (!selectFaculty || selectFaculty === 'Select Department') {
                showNotification("Select a department first.", '#fe3232bc');
                return;
            }
        ...
        const debouncedInputHandler = debounce(function(event) {
            ...
            fetch(`/admin-tasks/department/category/search?query=${query}&category=late-completed`)
                .then(response => response.json())
                .then(newTasks => {
                    tasks = newTasks;
                    newlyAdded = null;
