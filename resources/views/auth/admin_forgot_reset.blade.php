...
@section('title', 'PUPQC - Admin Reset Password')

@section('styles')
    <link rel="stylesheet" type="text/css" href="{{ asset('auth/css/admin_forgot_reset.css') }}">
@endsection
...
@section('body')
    <div class="login container input-shadow">
        <div class="components">
            ...
            <h1 class="my-3 title">Admin Reset Password</h1>
