...
@section('title', 'PUPQC - Faculty Login')

@section('styles')
    <link rel="stylesheet" type="text/css" href="{{ asset('auth/css/login_faculty.css') }}">
@endsection
...
@section('body')
    <div class="login container">
        <div class="components">
            ...
            <h1 class="my-3">Faculty Login</h1>

            <div class="input mb-4">
                <form action="{{ route('validate-login-faculty') }}" method="post">
                    ...
                    <div class="form-group mx-5">
                        ...
                        <div class="row px-2 my-2 hyperlinks">
                            <div class="col-sm">
                                <a href="{{ route('faculty-password-forgot') }}"><p class="hyperlinks label-css">Forgot Password</p></a>
                            </div>
                            <div class="col-sm" style="margin-left: -15%;">
                                <a href="{{ route('register-faculty')}}"><p class="hyperlinks label-css">Don't have an account? Register</p></a>
                            </div>
                        </div>
                    </div>
