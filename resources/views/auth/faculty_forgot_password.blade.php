...
@section('title', 'PUPQC - Faculty Forgot Password')

@section('styles')
    <link rel="stylesheet" type="text/css" href="{{ asset('auth/css/faculty_forgot_password.css') }}">
@endsection
...
@section('body')
    <div class="login container input-shadow">
        <div class="components">
            ...
            <h1 class="my-3 title">Faculty Forgot Password</h1>

            <div class="input mb-4">
                <form action="{{ route('faculty-password-link') }}" method="post">
