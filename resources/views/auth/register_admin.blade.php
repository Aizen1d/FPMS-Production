...
@section('title', 'PUPQC - Admin Register')

@section('styles')
    <link rel="stylesheet" type="text/css" href="{{ asset('auth/css/register_admin.css') }}">
@endsection
...
@section('body')
    <div class="login container input-shadow">
        <div class="components">
            ...
            <h1 class="my-3 title">Admin Registration Form</h1>
